    ...
    const dummyDataDatabase = [
      {
        ...
        maksimum_penghasilan: 2000000,
        stok: 20,
        deskripsi:
          "Berisi beras berkualitas tinggi yang sangat cocok untuk dimakan bersama keluarga",
      },
      {
        id_paket: 102,
        nama_paket: "Minyak Goreng 2L",
        maksimum_penghasilan: 2500000,
        stok: 30,
        deskripsi:
          "Minyak goreng kemasan 2 liter, cocok untuk kebutuhan memasak sehari-hari",
      },
      {
        id_paket: 103,
        nama_paket: "Telur 1 Kg",
        maksimum_penghasilan: 3000000,
        stok: 25,
        deskripsi:
          "Paket mie instan lengkap dengan berbagai rasa favorit keluarga",
      },
      {
        id_paket: 104,
        nama_paket: "Gula 1 Kg",
        maksimum_penghasilan: 2200000,
        stok: 40,
        deskripsi:
          "Gula pasir berkualitas yang bisa digunakan untuk membuat minuman dan kue",
      },
      {
        id_paket: 105,
        nama_paket: "Susu Kental Manis",
        maksimum_penghasilan: 2700000,
        stok: 18,
        deskripsi:
          "Telur ayam segar yang bisa dimasak berbagai hidangan bergizi",
      },
      {
        id_paket: 106,
        ...
        stok: 50,
        deskripsi:
          "Susu bubuk yang baik untuk anak-anak dan dewasa, kaya kalsium",
      },
      {
        id_paket: 107,
        nama_paket: "Sabun Mandi & Cuci",
        maksimum_penghasilan: 2400000,
        stok: 35,
        deskripsi:
          "Tepung terigu serbaguna cocok untuk membuat kue, roti, dan gorengan",
      },
      {
        id_paket: 108,
        nama_paket: "Beras Premium 10kg",
        maksimum_penghasilan: 1800000,
        stok: 15,
        deskripsi:
          "Kopi bubuk premium dengan aroma khas, cocok untuk dinikmati pagi hari",
      },
    ];
